...
-- 3. What is the age distribution of employes in the company?
SELECT
  min(age) AS youngest,
  max(age) AS oldest
FROM hr
...
-- How gender is distributed among the age_group?
SELECT
  CASE
    WHEN age >= 18 AND age <=24 THEN '18-24'
    WHEN age >= 25 AND age <=34 THEN '25-34'
...
-- 4. How many employeees work at headquarters versus remote locations?
...
-- 6. How does the gender distribution vary accross department and job titles?
